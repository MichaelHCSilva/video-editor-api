...
@Service
public class VideoStatusManagerService {

    private static final Logger logger = LoggerFactory.getLogger(VideoStatusManagerService.class);

    @Value("${video.retry.max-attempts}")
    private int maxRetries;

    public VideoStatusManagerService() {
    }
