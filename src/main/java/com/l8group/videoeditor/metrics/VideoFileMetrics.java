...
public class VideoFileMetrics {
    ...
    public VideoFileMetrics(MeterRegistry registry) {
        ...
        Gauge.builder("video_file_processing_queue_size", processingQueueSize, AtomicLong::get)
